	...
	public void updateTables(QueryResult qr) {
		...
		if (qr.next()) {
			...
			if (version < 1.35) {
				...
				sw.convertQueue("CREATE TABLE IF NOT EXISTS hyperconomy_shops_temp (NAME VARCHAR(100) NOT NULL PRIMARY KEY, TYPE VARCHAR(255) NOT NULL, ECONOMY VARCHAR(255) NOT NULL, OWNER VARCHAR(255) NOT NULL, WORLD VARCHAR(255) NOT NULL, USE_ECONOMY_STOCK TINYTEXT NOT NULL DEFAULT '1', MESSAGE TEXT NOT NULL, BANNED_OBJECTS TEXT NOT NULL, ALLOWED_PLAYERS TEXT NOT NULL, P1X DOUBLE NOT NULL, P1Y DOUBLE NOT NULL, P1Z DOUBLE NOT NULL, P2X DOUBLE NOT NULL, P2Y DOUBLE NOT NULL, P2Z DOUBLE NOT NULL)");
				sw.writeQueue();
