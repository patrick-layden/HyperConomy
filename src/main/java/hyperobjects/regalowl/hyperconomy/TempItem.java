...
public class TempItem extends BasicObject implements HyperItem {
	...
	public TempItem(String name, String economy, String type, String category, String material, int id, int data, int durability, double value, String isstatic, double staticprice, double stock, double median, String initiation, double startprice, double ceiling, double floor, double maxstock) {
