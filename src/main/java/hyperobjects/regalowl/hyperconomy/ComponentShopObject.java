...
public class ComponentShopObject implements HyperObject, PlayerShopObject {
	...
	ComponentShopObject(PlayerShop playerShop, HyperObject ho, double stock, double price, HyperObjectStatus status) {
		hc = HyperConomy.hc;
		sw = hc.getSQLWrite();
