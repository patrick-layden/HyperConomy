...
public class Enchant extends BasicObject implements HyperEnchant {
	...
	public Enchant(String name, String economy, String type, String category, String enchantName, int eid, double value, String isstatic, double staticprice, double stock, double median, String initiation, double startprice, double ceiling, double floor, double maxstock) {
	...
	public void setEnchantmentId(int eid) {
		String statement = "UPDATE hyperconomy_objects SET ID='" + eid + "' WHERE NAME = '" + name + "' AND ECONOMY = '" + economy + "'";
		hc.getSQLWrite().executeSQL(statement);
		this.eid = eid;
	}
