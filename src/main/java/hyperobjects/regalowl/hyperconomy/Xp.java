...
public class Xp extends BasicObject implements HyperXP {
	...
	public Xp(String name, String economy, String type, String category, double value, String isstatic, double staticprice, double stock, double median, String initiation, double startprice, double ceiling, double floor, double maxstock) {
