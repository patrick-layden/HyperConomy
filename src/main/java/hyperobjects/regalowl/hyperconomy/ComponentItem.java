...
public class ComponentItem extends BasicObject implements HyperItem {
	...
	public ComponentItem(String name, String economy, String type, String material, int data, int durability, double value, String isstatic, double staticprice, double stock, double median, String initiation, double startprice, double ceiling, double floor, double maxstock) {
