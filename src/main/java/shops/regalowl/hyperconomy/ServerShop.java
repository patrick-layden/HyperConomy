...
public class ServerShop implements Shop, Comparable<Shop>{
	...
	ServerShop(String name, String economy, HyperPlayer owner, String message, Location p1, Location p2, String banned_objects) {
		loaded = false;
		hc = HyperConomy.hc;
	...
	ServerShop(String shopName, String economy, HyperAccount owner, Location p1, Location p2) {
		loaded = false;
		hc = HyperConomy.hc;
		L = hc.getLanguageFile();
		useshopexitmessage = hc.gYH().gFC("config").getBoolean("config.use-shop-exit-message");
	 ...
	 * @param owner
	 */
	ServerShop(String name, String economy, HyperPlayer owner) {
		loaded = false;
		hc = HyperConomy.hc;
		L = hc.getLanguageFile();
		useshopexitmessage = hc.gYH().gFC("config").getBoolean("config.use-shop-exit-message");	
